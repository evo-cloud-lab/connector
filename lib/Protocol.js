...
var NODESTATES_SCHEMA = {
    revision:   'integer',
    actual:     { nullable: true },
    expect:     { nullable: true }
};
...
var NODE_SCHEMA = {
    ...
    address:    'ip',
    port:       'integer',
    states:     Schema.nest(NODESTATES_SCHEMA)
};
...
module.exports = {
    ...
    parse: function(msg, schemas) {
        ...
        var schema = typeof(msg) == 'object' && schemas[msg.event];
        var data = schema && typeof(msg.data) == 'object' && Schema.accept(schema, msg.data);
